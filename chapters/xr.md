...
This list is of course far from exhaustive: In addition to the countermeasures just described, [@Jerald:201667e, Chapter 19] offers a very comprehensive list of guidelines to counter adverse health effects when designing and using VR systems. In addition, [@Clift:2018ncs] provides a review of both software and hardware solutions against motion sickness in VR.
