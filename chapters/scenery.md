...
* __OpenGL 4.0+/Vulkan support__ - To harness the power of current GPUs, the software should support state-of-the-art rendering APIs like Vulkan and/or OpenGL 4.0+ [^1].
...
[^1]: A higher OpenGL version than 4.1 would also be desirable, but macOS only supports up to 4.1, unfortunately.
